...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
                ...
                if (pullResult != null) {
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND:
                            ...
                            //为空，将pullRequest放到pullRequestQueue
                            if (pullResult.getMsgFoundList() == null || pullResult.getMsgFoundList().isEmpty()) {
                                ...
                                //将消息存入ProcessQueue，然后将拉取到的消息提交到ConsumeMessageService中供消费者消费
    ...
    /**
     * 构建主题订阅信息 SubscriptionData 并加入到 RebalanceImpl 的订阅消息中 。 订 阅关系来源主要有两个 。
     */
